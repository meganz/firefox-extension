...
sh1['js/crypto_6.js'] = [1176986251,311213770,1289367305,1602143879,-1496468445,-151671728,-1796856402,814100792];
...
sh1['js/filedrag_2.js'] = [81532992,-2084077012,-1380799128,-927388603,1751831544,-910142112,-2043988355,682778192];
...
sh1['js/mega_24.js'] = [1957932327,615408186,115838617,-37824228,-1444247316,1585712537,54763190,-420185276];
sh1['js/fm_20.js'] = [415526212,-772711510,2039832402,1998479623,354079717,366680842,1451611664,-1563018906];
sh1['js/filetypes_2.js'] = [-1917187443,-457112069,-524491192,1551179979,-685045582,-1956517230,1113761487,292075913];
sh1['index_10.js'] = [-512981403,935607097,1587388166,-1004178536,-707713213,-2089190763,-1926859799,-1253711143];
...
sh1['html/fm_6.html'] = [1309464909,-554321514,124226444,-410254127,1064673542,-170536157,-866630099,132447470];
...
sh1['css/style_15.css'] = [1670435819,2068420869,-1749964040,1054837015,1011784510,1530643311,1884638504,-1083187443];
...
sh1['html/dialogs_7.html'] = [-691517886,-2078862506,-470993474,-1047456348,54423875,-1996279615,-1119118652,-949902752];
...
else
{
	if (!b_u)
	{
		...
		jsl.push({f:'js/crypto_6.js', n: 'crypto_js', j:1,w:5});
		...
		jsl.push({f:'js/filedrag_2.js', n: 'filedrag_js', j:1});
		...
		jsl.push({f:'js/mega_24.js', n: 'mega_js', j:1,w:7});
		jsl.push({f:'js/fm_20.js', n: 'fm_js', j:1,w:12});
		jsl.push({f:'js/filetypes_2.js', n: 'filetypes_js', j:1});
		jsl.push({f:'index_10.js', n: 'index', j:1,w:4});
		...
		jsl.push({f:'html/fm_6.html', n: 'fm', j:0,w:3});
		...
		jsl.push({f:'css/style_15.css', n: 'style_css', j:2,w:30,c:1,d:1,cache:1});
		jsl.push({f:'js/avatar_2.js', n: 'avatar_js', j:1,w:3});
		jsl.push({f:'js/countries_2.js', n: 'countries_js', j:1});
		jsl.push({f:'html/dialogs_7.html', n: 'dialogs', j:0,w:2});
