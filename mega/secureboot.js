...
sh1['js/mega_23.js'] = [-1401751676,-885280203,-2077181661,-800701429,736354454,-1207619293,-1338001332,-2060610973];
sh1['js/fm_19.js'] = [-469442004,1069272458,1446594157,-1732934051,-356405594,1892031053,800614709,-2005507423];
...
sh1['css/style_14.css'] = [-300055747,788951430,-1128657310,1498069669,1044265588,367735353,-1767355984,1263502756];
...
sh1['html/android_31.html'] = [-474954686,-1728308204,-1694763832,-1720731356,665731556,1687917388,-1533699813,2018687061];
...
else
{
	if (!b_u)
	{
		...
		jsl.push({f:'js/mega_23.js', n: 'mega_js', j:1,w:7});
		jsl.push({f:'js/fm_19.js', n: 'fm_js', j:1,w:12});
		...
		jsl.push({f:'css/style_14.css', n: 'style_css', j:2,w:30,c:1,d:1,cache:1});
		...
		var jsl2 =
		{
			...
			'android': {f:'html/android_31.html', n: 'android', j:0},
