...
sh1['js/upload_3.js'] = [-1917795142,1089146426,-571938418,2120658098,1313614839,-680017926,716265904,470789115];
...
sh1['js/mega_25.js'] = [-1507649547,1579295630,469060258,-320263334,-584618671,705317773,-560945134,1564394042];
sh1['js/fm_21.js'] = [-429477958,1128313218,1792808357,608968583,1111700707,-717943408,1087805976,-571819126];
...
sh1['css/style_16.css'] = [-153431095,914051622,-1639427141,347953468,1852671916,-1522742324,-1129321395,-2022277068];
...
else
{
	if (!b_u)
	{
		...
		jsl.push({f:'js/upload_3.js', n: 'upload_js', j:1,w:2});
		...
		jsl.push({f:'js/mega_25.js', n: 'mega_js', j:1,w:7});
		jsl.push({f:'js/fm_21.js', n: 'fm_js', j:1,w:12});
		...
		jsl.push({f:'css/style_16.css', n: 'style_css', j:2,w:30,c:1,d:1,cache:1});
